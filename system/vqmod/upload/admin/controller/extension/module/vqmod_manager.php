...
class ControllerExtensionModuleVQModManager extends Controller
{
    ...
    public function index()
    {
        ...
        // Action Buttons
        $data['action'] = $this->url->link('extension/module/vqmod_manager', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['cancel'] = $this->url->link('extension/module', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['clear_log'] = $this->url->link('extension/module/vqmod_manager/clear_log', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['clear_vqcache'] = $this->url->link('extension/module/vqmod_manager/clear_vqcache', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['download_log'] = $this->url->link('extension/module/vqmod_manager/download_log', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['download_scripts'] = $this->url->link('extension/module/vqmod_manager/download_vqmod_scripts', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['download_vqcache'] = $this->url->link('extension/module/vqmod_manager/download_vqcache', 'user_token=' . $this->session->data['user_token'], 'SSL');
            ...
            foreach ($vqmod_scripts as $vqmod_script) {
                ...
                if ($extension == 'xml_') {
                    $action[] = array(
                        ...
                        'href' => $this->url->link('extension/module/vqmod_manager/vqmod_install', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . $file, 'SSL')
                    );
                } else {
                    $action[] = array(
                        'text' => $this->language->get('text_uninstall'),
                        'href' => $this->url->link('extension/module/vqmod_manager/vqmod_uninstall', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . $file, 'SSL')
                    );
                }
                ...
                $data['vqmods'][] = array(
                    ...
                    'delete' => $this->url->link('extension/module/vqmod_manager/vqmod_delete', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . basename($vqmod_script), 'SSL'),
                    'action' => $action,
    ...
    public function vqmod_install()
    {
        ...
        $this->response->redirect($this->url->link('extension/module/vqmod_manager', 'user_token=' . $this->session->data['user_token'], 'SSL'));
    }
